...
Version: 2.1.3_rc2
Release: 1%{dist}
Source0: harbor_core-v2.1.3-rc2
Source1: harbor-core.service
Source2: app.conf
Source3: env
Source4: db-v2.1.3-rc2.tar.gz
Source5: reset-password-mail.tpl
Source6: 404.tpl
Source7: prepareapp-v2.1.3-rc2.tar.gz
Source8: harbor.yml
License: GPLv3
Group: System Tools
...
mv db-v2.1.3-rc2/db/ $RPM_BUILD_ROOT%{service_configdir}/db/initial
mv db-v2.1.3-rc2/migrations/postgresql $RPM_BUILD_ROOT%{service_configdir}/db/migrations
cd %{buildroot}/%{service_homedir}/setup/ && tar zxf %{SOURCE7}
echo "2.1.3_rc2" > $RPM_BUILD_ROOT%{service_homedir}/core/UIVERSION
